...
namespace TournamentManagerTests.Logic.Matching.BlossomV
{
    ...
    public class KolmogorovWeightedPerfectMatchingTests
    {
        ...
        {
            long[,] edges = new long[,] { { 1, 2, 8 }, { 2, 3, 8 }, { 3, 4, 8 }, { 4, 1, 8 }, { 2, 4, 2 } };
            double maxWeight = 16;
            double minWeight = 16;
        ...
        {
            long[,] edges = new long[,] { { 1, 3, 11 }, { 1, 4, 8 }, { 2, 3, 8 }, { 2, 4, 2 } };
            double maxWeight = 16;
            double minWeight = 13;
        ...
        {
            long[,] edges = new long[,] { { 0, 3, 7 }, { 0, 4, 5 }, { 0, 5, 2 }, { 1, 3, 1 },
        ...
        {
            long[,] edges = new long[,] { { 0, 3, 7 }, { 0, 4, 3 }, { 0, 5, 9 }, { 1, 3, 8 },
        ...
        {
            long[,] edges = new long[,] { { 0, 1, 2 }, { 0, 2, 5 }, { 0, 3, 1 }, { 1, 2, 5 },
            { 1, 3, 2 }, { 2, 3, 1 } };
        ...
        {
            long[,] edges = new long[,] { { 0, 1, 1 }, { 0, 2, 4 }, { 0, 3, 7 }, { 0, 4, 10 }, { 1, 2, 5 },
        ...
        {
            long[,] edges = new long[,] { { 0, 1, 1 }, { 0, 2, 6 }, { 0, 3, 1 }, { 0, 4, 1 }, { 1, 2, 6 },
        ...
        {
            long[,] edges = new long[,] { { 0, 1, 4 }, { 0, 2, 4 }, { 0, 3, 6 }, { 0, 4, 8 }, { 1, 2, 8 },
        ...
        {
            long[,] edges = new long[,] { { 0, 1, 5 }, { 0, 2, 1 }, { 0, 3, 8 }, { 0, 4, 1 }, { 1, 2, 2 },
        ...
        {
            long[,] edges = new long[,] { { 0, 1, 2 }, { 0, 2, 6 }, { 0, 3, 3 }, { 0, 4, 2 }, { 1, 2, 7 },
        ...
        {
            long[,] edges = new long[,] { { 2, 0, 5 }, { 2, 1, 9 }, { 3, 0, 2 }, { 3, 1, 6 },
        ...
        {
            long[,] edges = new long[,] { { 1, 0, 9 }, { 2, 0, 8 }, { 2, 1, 3 }, { 3, 0, 5 }, { 3, 1, 4 },
        ...
        {
            long[,] edges = new long[,] { { 1, 0, 8 }, { 2, 0, 7 }, { 2, 1, 10 }, { 3, 0, 8 }, { 3, 1, 5 },
        ...
        {
            long[,] edges = new long[,] { { 0, 1, 3 }, { 0, 2, 2 }, { 0, 3, 8 }, { 0, 4, 10 },
        ...
        {
            long[,] edges = new long[,] { { 1, 0, 7 }, { 1, 2, 3 }, { 0, 2, 7 }, { 0, 3, 9 },
        ...
        {
            long[,] edges = new long[,] { { 0, 1, 10 }, { 0, 2, 7 }, { 1, 2, 4 }, { 2, 3, 1 },
        ...
        {
            long[,] edges = new long[,] { { 0, 1, 6 }, { 0, 2, 4 }, { 1, 2, 4 }, { 2, 3, 6 },
        ...
        {
            long[,] edges = new long[,] { { 2, 3, 2 }, { 2, 4, 5 }, { 3, 4, 4 }, { 0, 2, 4 },
        ...
        {
            long[,] edges = new long[,] { { 0, 1, 10 }, { 0, 2, 8 }, { 1, 2, 3 }, { 0, 3, 7 },
        ...
        {
            long[,] edges = new long[,] { { 1, 0, 7 }, { 1, 4, 8 }, { 0, 4, 6 }, { 0, 5, 7 },
        ...
        {
            long[,] edges = new long[,] { { 1, 0, 14 }, { 1, 2, 12 }, { 0, 2, 7 }, { 0, 3, 7 },
        ...
        {
            long[,] edges = new long[,] { { 0, 2, 5 }, { 0, 3, 8 }, { 2, 3, 6 }, { 0, 1, 9 },
        ...
        {
            long[,] edges = new long[,] { { 0, 1, 8 }, { 0, 2, 10 }, { 1, 2, 3 }, { 0, 3, 8 },
        ...
        {
            long[,] edges = new long[,] { { 0, 1, 5 }, { 0, 2, 5 }, { 1, 2, 3 }, { 1, 3, 4 },
        ...
        {
            long[,] edges = new long[,] { { 0, 1, 5 }, { 0, 3, 5 }, { 1, 3, 3 }, { 2, 4, 3 },
        ...
        {
            long[,] edges = new long[,] { { 0, 2, 5 }, { 0, 3, 3 }, { 2, 3, 3 }, { 0, 1, 17 },
        ...
        {
            long[,] edges = new long[,] { { 0, 2, 44 }, { 0, 3, 50 }, { 2, 3, 6 }, { 2, 4, 6 },
        ...
        {
            long[,] edges = new long[,] { { 0, 1, 34 }, { 0, 2, 146 }, { 1, 2, 113 }, { 1, 3, 34 },
        ...
        {
            long[,] edges = new long[,] { { 0, 1, 118 }, { 0, 2, 125 }, { 1, 2, 7 }, { 0, 3, 66 },
        ...
        {
            long[,] edges = new long[,] { { 0, 1, 48 }, { 0, 3, 23 }, { 1, 3, 27 }, { 1, 6, 14 },
        ...
        {
            long[,] edges = new long[,] { { 1, 2, 47 }, { 1, 3, 33 }, { 2, 3, 15 }, { 1, 5, 18 },
        ...
        {
            long[,] edges = new long[,] { { 0, 1, 14 }, { 0, 6, 13 }, { 1, 6, 3 }, { 3, 4, 16 },
        ...
        {
            long[,] edges = new long[,] { { 3, 4, 8 }, { 3, 8, 8 }, { 4, 8, 2 }, { 4, 5, 4 },
        ...
        {
            long[,] edges = new long[,] { { 4, 5, 4 }, { 4, 14, 3 }, { 5, 14, 3 }, { 5, 6, 4 },
        ...
        {
            long[,] edges = new long[,] { { 1, 0, 597 }, { 2, 0, 614 }, { 2, 1, 57 }, { 3, 0, 554 },
        ...
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArgumentException), "There is no perfect matching in the specified graph")]
        public void TestInvalidGraphs1()
        {
            long[,] edges = new long[,] { { 1, 3, 11 }, { 1, 4, 8 }, { 2, 3, 8 }, { 2, 4, 2 } };
        
            Pair<IGraph<long, Pair<long, long>>, Dictionary<Pair<long, long>, double>> res = TestUtil.ConstructGraph(edges);
            Assert.IsTrue(res.GetFirst().AddVertex(5));
        ...
        /// <summary>
        /// Test on a graph with two vertices without edge
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArgumentException), "There is no perfect matching in the specified graph")]
        public void TestInvalidGraphs2()
        {
            long[,] edges = new long[,] { };

            Pair<IGraph<long, Pair<long, long>>, Dictionary<Pair<long, long>, double>> res = TestUtil.ConstructGraph(edges);
            Assert.IsTrue(res.GetFirst().AddVertex(5));
            Assert.IsTrue(res.GetFirst().AddVertex(6));
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException), "There is no perfect matching in the specified graph")]
        public void TestInvalidGraphs3()
        {
            long[,] edges = new long[,] { { 1, 2, 1 }, { 1, 3, 2 }, { 2, 3, 3 }, };

            Pair<IGraph<long, Pair<long, long>>, Dictionary<Pair<long, long>, double>> res = TestUtil.ConstructGraph(edges);
            Assert.IsTrue(res.GetFirst().AddVertex(4));
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException), "There is no perfect matching in the specified graph")]
        public void TestInvalidGraphs4()
        {
            long[,] edges = new long[,] { { 1, 2, 3 }, { 1, 3, 5 }, { 2, 3, 7 }, { 1, 4, 6 },
            { 3, 4, 1 }, { 1, 0, 11 }, { 0, 4, 7 }, { 3, 5, 3 }, { 4, 5, 2 }, { 4, 6, 3 },
            { 5, 6, 1 }, { 4, 7, 3 }, { 0, 7, 7 }, { 6, 7, 1 }, { 6, 8, 9 }, { 5, 8, 8 },
            { 7, 8, 10 }, { 3, 8, 7 }, { 2, 8, 4 } };

            Pair<IGraph<long, Pair<long, long>>, Dictionary<Pair<long, long>, double>> res = TestUtil.ConstructGraph(edges);
            Assert.IsTrue(res.GetFirst().AddVertex(9));
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException), "There is no perfect matching in the specified graph")]
        public void TestInvalidGraphs5()
        {
            long[,] edges = new long[,] { { 0, 1, 8 }, { 0, 2, 9 }, { 1, 2, 1 }, { 0, 3, 4 },
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException), "There is no perfect matching in the specified graph")]
        public void TestInvalidGraphs6()
        {
            long[,] edges = new long[,] { { 1, 2, 22 }, { 1, 3, 8 }, { 2, 3, 16 }, { 0, 1, 46 },
            ...
            Pair<IGraph<long, Pair<long, long>>, Dictionary<Pair<long, long>, double>> res = TestUtil.ConstructGraph(edges);
            Assert.IsTrue(res.GetFirst().AddVertex(99));
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException), "There is no perfect matching in the specified graph")]
        public void TestInvalidGraphs7()
        {
            long[,] edges = new long[,] { { 0, 2, 18 }, { 1, 2, 27 }, { 0, 3, 68 }, { 1, 3, 15 },
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException), "There is no perfect matching in the specified graph")]
        public void TestInvalidGraphs8()
        {
            long[,] edges = new long[,] { { 0, 2, 72 }, { 1, 2, 85 }, { 0, 3, 5 }, { 1, 3, 59 },
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException), "There is no perfect matching in the specified graph")]
        public void TestInvalidGraphs9()
        {
            long[,] edges = new long[,] { { 0, 2, 87 }, { 1, 2, 56 }, { 0, 3, 21 }, { 1, 3, 81 },
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException), "There is no perfect matching in the specified graph")]
        public void TestInvalidGraphs10()
        {
            long[,] edges = new long[,] { { 0, 2, 44 }, { 1, 2, 27 }, { 0, 3, 2 }, { 1, 3, 73 },
        ...
        /// </summary>
        /// <param name="edges">edges of the graph (start and end vertex + weight)</param>
        /// <param name="resultMin">expected result for minimum weight matching</param>
        /// <param name="resultMax">expected result for maximum weight matching</param>
